...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img src="images/iphone_16e.jpg" alt="">
         </div>
         <div class="content">
            <span>Нови модели</span>
            <h3>Iphone 16e</h3>
            <a href="quick_view.php?pid=2 " class="btn">Купи сега</a>
         </div>
      </div>
      ...
      <div class="swiper-slide slide"> 
         ...
         <div class="content">
            ...
            <a href="quick_view.php?pid=4" class="btn">Купи сега</a>
         </div>
      </div>

      <div class="swiper-slide slide">
         <div class="image">
            <img src="images/iphone16.jpg" alt="">
         </div>
         <div class="content">
            <span>Нови модели</span>
            <h3>Iphone 16 pro max</h3>
            <a href="quick_view.php?pid=1" class="btn">Купи сега</a>
         </div>
      </div>
...
<section class="category">
   ...
   <h1 class="heading">Производител</h1>
   ...
   <a href="category.php?category=HMD" class="swiper-slide slide">
      <img src="images/HMD.png" alt="">
      <h3>HMD</h3>
   </a>

   <a href="category.php?category=Huawei" class="swiper-slide slide">
...
<section class="home-products">
   ...
   <h1 class="heading">Нови модели</h1>
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <div class="flex">
         <div class="price"><span>BGN</span><?= $fetch_product['price']; ?><span>/-</span></div>
