...
<div class="box-container">
   ...
   <div class="box">
      ...
      <p> Общо продукти : <span><?= $fetch_orders['total_products']; ?></span> </p>
      ...
      <form action="" method="post">
        ...
        <div class="flex-btn">
         ...
         <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('Искате ли да изтрийте тази поръчка?');">Изтрий</a>
        </div>
      </form>
   </div>
   <?php
