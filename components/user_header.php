...
<header class="header">
   ...
   <a href="home.php" class="logo">
    <span>Smart</span>phone<span>.</span> 
    <i class="fa-solid fa-mobile-screen-button"></i></a>
      ...
      <nav class="navbar">
         ...
         <a href="shop.php">Продукти</a>
         <a href="contact.php">Контакт с нас</a>
      </nav>
      ...
      <div class="profile">
         ...
         <a href="update_user.php" class="btn">Обнови профил</a>
         <div class="flex-btn">
            <a href="user_register.php" class="option-btn">Регистрация</a>
            <a href="user_login.php" class="option-btn">Вход</a>
         </div>
         <a href="components/user_logout.php" class="delete-btn" onclick="return confirm('logout from the website?');">Изход</a> 
         <?php
            }else{
         ?>
